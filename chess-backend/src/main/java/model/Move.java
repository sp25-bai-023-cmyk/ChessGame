...
public class Move {
    ...
    private Piece moved_piece;         // Jo piece move hua
    private Piece dead_piece;      // Agar koi piece mara gaya

    public Move(int start_Row, int start_Col, int end_row, int end_col,
                Piece moved_piece, Piece dead_piece) {
    ...
    public Piece getMoved_piece() { return moved_piece; }
